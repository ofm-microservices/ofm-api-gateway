...
var (
	...
	ErrInvalidChatMessageID         = errors.New("invalid chat message id")
	ErrInvalidChatCursor            = errors.New("invalid chat cursor")
	ErrInvalidChatFileID            = errors.New("invalid chat file id")
	ErrInvalidChatFilename          = errors.New("invalid chat filename")
	ErrInvalidChatContentType       = errors.New("invalid chat content type")
	ErrInvalidChatSizeBytes         = errors.New("invalid chat size bytes")
	...
	ErrInvalidOrderMessage          = errors.New("invalid order message")
